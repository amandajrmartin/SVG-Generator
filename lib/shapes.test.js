...
describe('Square Test', () => {
    test('Will this return a new square', () => {
...
describe('Triangle Test', () => {
    test('Will this return a new triangle', () => {
        const triangle = new Triangle('AJM', 'white', 'Sienna')
        expect(triangle.render()).toEqual(`<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg">

        <polygon points="150, 18 244, 182 56, 182" fill="Sienna" />
